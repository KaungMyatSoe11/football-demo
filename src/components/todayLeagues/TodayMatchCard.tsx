...
const TodayMatchCard = ({ opponent }: TodayMatchCardProps) => {
  ...
  return (
    <div className="mb-5 p-5 rounded-lg shadow-md bg-gradient-to-r from-[#E6E6FA] to-[#D8BFD8] dark:from-gray-800 dark:to-gray-700 hover:scale-105 transition-all">
      <div className="grid grid-cols-3 gap-4 items-baseline text-center sm:gap-3">
        {/* Left Team */}
        <div className="flex flex-col items-center space-y-2">
          ...
          />
          <span className="text-xs sm:text-base font-semibold text-gray-800 dark:text-gray-200">
